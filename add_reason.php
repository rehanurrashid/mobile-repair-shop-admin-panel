                    ...
                    <div class="col-md-9 col-sm-9">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="fa fa-bars"></i>Add Reason</div>
                            </div>
                            <div class="portlet-body">
                                <form action="reason/add.php" method="post" name="frm" enctype="multipart/form-data" class="form-horizontal row-border" id="validate-1" novalidate="novalidate">
