                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body">
                                <form action="http://admin.keshavinfotechdemo.com/Update_Request.php" method="post" name="frm" enctype="multipart/form-data" onSubmit="javascript:return keshav_check();" class="form-horizontal row-border" id="validate-1" novalidate="novalidate">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control required" name="category" id="category" onChange="show_combo1(this.value)">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control required" name="name" type="text" id="name" value="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                            <span class="required">*</span>SKU
                                        </label>
                                        <div class="col-md-9">
                                            <input class="form-control required" name="sku" type="text" id="sku" value="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control required" name="price" type="text" id="price" value="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                            <span class="required">*</span>Stock
                                        </label>
                                        <div class="col-md-9">
                                            <input class="form-control required" name="stock" type="text" id="stock" value="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                            <span class="required">*</span>Full Description
                                        </label>
                                        <div class="col-md-9"> <textarea name="fulldescription" rows="4" cols="40" style="width: 100%; height: 500px"></textarea> </div>
                                    </div>
...
<!-- Mirrored from admin.keshavinfotechdemo.com/Update_Request.php?mode=Update by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Nov 2019 06:40:38 GMT -->
