                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="fa fa-bars"></i>Update Device</div>
                            </div>
                            <div class="portlet-body">
                                <form action="http://admin.keshavinfotechdemo.com/add_Device.php" method="post" name="frm" enctype="multipart/form-data" onSubmit="javascript:return keshav_check();" class="form-horizontal row-border" id="validate-1" novalidate="novalidate">
                                    <input type="hidden" name="mode" id="mode" value="add">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                            <span class="required">*</span>Device Name
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                            <span class="required">*</span>Device Model
                                        </label>
                                        <div class="col-md-9">
                                            <input class="form-control required" name="model" type="text" id="model" value="" />
                                        </div>
                                    </div>
...
<!-- Mirrored from admin.keshavinfotechdemo.com/Update_Device.php?mode=Update by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Nov 2019 06:40:38 GMT -->
