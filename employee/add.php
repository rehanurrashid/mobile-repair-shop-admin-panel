<?php
    ...
    if(!empty($emp->emp_id)){
            ...
            $check = $emp->create();
            if($check){
                 header("location: ../manage_employees.php?message=true");
            }
             else if($check=="exists"){
                header("location: ../manage_employees.php?message=exists");
             }
            // if unable to create
            else{
                header("location: ../manage_employees.php?message=false");
            }
        }
    }
    else{
