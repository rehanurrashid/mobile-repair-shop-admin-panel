                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body">
                                <form action="http://admin.keshavinfotechdemo.com/add_Reason.php" method="post" name="frm" enctype="multipart/form-data" onSubmit="javascript:return keshav_check();" class="form-horizontal row-border" id="validate-1" novalidate="novalidate">
...
<!-- Mirrored from admin.keshavinfotechdemo.com/Update_Reason.php?mode=Update by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Nov 2019 06:40:38 GMT -->
