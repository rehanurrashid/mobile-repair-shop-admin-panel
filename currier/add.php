<?php
    ...
    if(!empty($currier->currier_id)){
            // create
            $check = $currier->create();
            if($check){
                 header("location: ../manage_currier.php?message=true");
            }
             else if($check=="exists"){
                header("location: ../manage_currier.php?message=exists");
             }
            // if unable to create
            else{
                header("location: ../manage_currier.php?message=false");
            }
        }
    }
    else{
