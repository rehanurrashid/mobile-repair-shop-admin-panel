<?php
    ...
    if($_POST['warranty'] == "yes" && $_POST['accessories'] != "yes" && $_POST['ip'] == "yes"){
        ...
        if(move_uploaded_file($f_tmp_ip,$target_dir))
        {
            ...
            // $req->req_device_status         = "Not Received";
        ...
        if(!empty($req->req_uid)){
                ...
                // print_r($check);exit();
                if($check){
                     header("location: ../manage_requests.php?message=editsucessfully");
                }
                // if unable to update
                else{
                    header("location: ../manage_requests.php?message=editunsucessfull");
                }
            }
        }
        else{
