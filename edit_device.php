                    ...
                    <div class="col-md-9 col-sm-9">
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body">
                                <form action="device/edit.php" method="post" name="frm" enctype="multipart/form-data" onSubmit="javascript:return keshav_check();" class="form-horizontal row-border" id="validate-1" novalidate="novalidate">
        ...
        success:function(data)
        {
            ...
            var serial = 1;
                if(data.records.length>0)
                {
                    ...
                    {             
                        console.log(data.records[item].Device);

                        $('#did').val(data.records[item].did);
                        $('#name').val(data.records[item].name);
                        $('#model').val(data.records[item].model);  
                    }
                } 
                else
                {
